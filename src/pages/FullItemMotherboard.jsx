...
const FullItem = () => {
    ...
    const fetchComponent = async () => {
        try {
            setLoading(true)
            const {data} = await axios.get(`http://localhost:5555/Motherboards/${id}`)
            setData(data)
            setLoading(false)
        } catch (error) {
            setLoading(false)
        ...
        { isLoading ? <><SkeletonFullItem></SkeletonFullItem></> :
            ...
            <div data-meta-name="ProductHeaderLayout" class="app-catalog-1xdhyk6 e19nkc9p0">
                ...
                <div data-meta-name="ProductHeaderLayout__title" class="app-catalog-3z12b7 eotjnw00">
                    <h1 class="e1ubbx7u0 eml1k9j0 app-catalog-lc5se5 e1gjr6xo0" color="Main">Motherboard {data.title}</h1>
                </div>
                                ...
                                <div class="fresnel-container fresnel-greaterThan-tabletP ">
                                    <div class="app-catalog-0 e1re7ty40">
                                        <ul class="app-catalog-omvud7 eetknoe3">
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Форм-фактор:</span> <span class="app-catalog-kwpt08 eetknoe0">{data["form _factor"]["form_factor"]};</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Разъем питания материнской платы:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.mb_power_pin} pin;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Сокет:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.socket.socket};</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Чипсет:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.chipset.chipset};</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Разъем питания процессора:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.cpu_power_pin};</span></li>
                                            ...
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Количество слотов памяти:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.slots_ram};</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Частота памяти:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.frequency_ram} МГц;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Максимальный объем оперативной памяти:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.max_num_ram} ГБ;</span></li>
