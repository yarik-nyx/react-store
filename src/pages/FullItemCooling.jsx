...
const FullItem = () => {
    ...
    const fetchComponent = async () => {
        try {
            setLoading(true)
            const {data} = await axios.get(`http://localhost:5555/Coolings/${id}`)
            setData(data)
            setLoading(false)
        } catch (error) {
            setLoading(false)
        ...
        { isLoading ? <><SkeletonFullItem></SkeletonFullItem></> :
            ...
            <div data-meta-name="ProductHeaderLayout" class="app-catalog-1xdhyk6 e19nkc9p0">
                ...
                <div data-meta-name="ProductHeaderLayout__title" class="app-catalog-3z12b7 eotjnw00">
                    <h1 class="e1ubbx7u0 eml1k9j0 app-catalog-lc5se5 e1gjr6xo0" color="Main">Cooling {data.title}</h1>
                </div>
                                ...
                                <div class="fresnel-container fresnel-greaterThan-tabletP ">
                                    <div class="app-catalog-0 e1re7ty40">
                                        <ul class="app-catalog-omvud7 eetknoe3">
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Тип охлаждения:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.type_cooling.type_cooling};</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Размер вентилятора:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.num_fan} мм.;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Максимальное тепловыделение процессора:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.TDP}  °С;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Сокеты:</span> <span class="app-catalog-kwpt08 eetknoe0">
                                                {
                                                    data.sockets.map(item => <p>{item.socket}</p>)
                                                }</span>
                                            </li>
                                        </ul>
                                    </div>
