...
const FullItem = () => {
    ...
    const onClickAdd = () => {
        setCount(++count)
        let item = {
                id:id+data.types[typeCurr]+data.letters[letterCurr],
                idPage: id,
                title:data.title,
                price:data.price,
    ...
    const fetchComponent = async () => {
        try {
            setLoading(true)
            const {data} = await axios.get(`http://localhost:5555/Processors/${id}`)
            setData(data)
            setLoading(false)
        } catch (error) {
            setLoading(false)
        ...
        { isLoading ? <><SkeletonFullItem></SkeletonFullItem></> :
            ...
            <div data-meta-name="ProductHeaderLayout" class="app-catalog-1xdhyk6 e19nkc9p0">
                ...
                <div data-meta-name="ProductHeaderLayout__title" class="app-catalog-3z12b7 eotjnw00">
                    <h1 class="e1ubbx7u0 eml1k9j0 app-catalog-lc5se5 e1gjr6xo0" color="Main">Processor {data.title}</h1>
                </div>
                                ...
                                <div class="fresnel-container fresnel-greaterThan-tabletP ">
                                    <div class="app-catalog-0 e1re7ty40">
                                        <ul class="app-catalog-omvud7 eetknoe3">
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Частота:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.base_frequency} и {data.max_frequency} в режиме Turbo;</span></li>
                                            ...
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Число ядер:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.num_of_cores}, {data.num_of_threads} потоков;</span></li>
                                            ...
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">L2 кэш:</span> <span class="app-catalog-kwpt08 eetknoe0">{Math.round(data.l2_cache)} MB;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">L3 кэш:</span> <span class="app-catalog-kwpt08 eetknoe0">{Math.round(data.l3_cache)} MB;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Максимальная температура:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.max_temp} °С;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Техпроцесс:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.texproc} нм;</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="fresnel-container fresnel-lessThan-tabletL "></div>
