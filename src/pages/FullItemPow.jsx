...
const FullItem = () => {
    ...
    const fetchComponent = async () => {
        try {
            setLoading(true)
            const {data} = await axios.get(`http://localhost:5555/PowerSupplies/${id}`)
            setData(data)
            setLoading(false)
        } catch (error) {
            setLoading(false)
        ...
        { isLoading ? <><SkeletonFullItem></SkeletonFullItem></> :
            ...
            <div data-meta-name="ProductHeaderLayout" class="app-catalog-1xdhyk6 e19nkc9p0">
                ...
                <div data-meta-name="ProductHeaderLayout__title" class="app-catalog-3z12b7 eotjnw00">
                    <h1 class="e1ubbx7u0 eml1k9j0 app-catalog-lc5se5 e1gjr6xo0" color="Main">Power supplies {data.title}</h1>
                </div>
                                ...
                                <div class="fresnel-container fresnel-greaterThan-tabletP ">
                                    <div class="app-catalog-0 e1re7ty40">
                                        <ul class="app-catalog-omvud7 eetknoe3">
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Мощность:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.power} Вт;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Мин. напряжение:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.min_voltage} В;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Макс. напряжение:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.max_voltage} В;</span></li>
                                            <li class="app-catalog-f3ulnv eetknoe2"><span class="app-catalog-lquems eetknoe1">Сертификат:</span> <span class="app-catalog-kwpt08 eetknoe0">{data.certificate?.certificate ?? 'Нет'};</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="fresnel-container fresnel-lessThan-tabletL "></div>
